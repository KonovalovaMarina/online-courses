...
TASKS = [
    {"name": "Hello world", "code": "hello_world", "text": "<p>Напишите фцнкцию которая возвращает текст \"Hello World\"</p><p>Загрузите файл содержащий функцию <code>def {{ task.code }}():</code></p>", "lecture_index": 0},
    {"name": "Hello universe", "code": "hello_universe", "text": "Напишите фцнкцию которая возвращает текст \"Hello Universe\"", "lecture_index": 0}
]
